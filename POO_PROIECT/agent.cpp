...
void Agent::actionPerTick(const Map &map) {
    ...
    if (this->currentState == MOVING) {
        ...
        if (map.grid[this->agentPosition.getPositionX()][this->agentPosition.getPositionY()] == 'S' || map.grid[this->agentPosition.getPositionX()][this->agentPosition.getPositionY()] == 'B') {
