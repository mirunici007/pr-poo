...
void Agent::actionPerTick(const Map &map) {
    ...
    if (this->currentState == MOVING) {
        ...
        if (map.grid[this->agentPosition.getPositionX()][this->agentPosition.getPositionY()] == STATION || map.grid[this->agentPosition.getPositionX()][this->agentPosition.getPositionY()] == HUB) {
